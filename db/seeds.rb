...
User.create(:email => "admin@admin.com",:fname=>"Billybob", :lname=>"Thorton-Jr.", :phone => "0000000000", :carrier=>"Verizon", :password => "123123123", :password_confirmation => "123123123", :admin => true)
